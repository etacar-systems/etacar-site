export const data = [
  ...
  {
    id: 2,
    title: '(b) What types of cookies may be used here?',
    paragraphs: [
  ...
  {
    id: 3,
    title: '(c) What cookies does this website use?',
    paragraphs: [
      'A list of all the cookies used on this site by category is detailed below Note: This website does not use any cookies which retain personal information about you after your session ends.',
  ...
  {
    id: 4,
    title: '(d) What if I don’t want cookies to be set?',
    paragraphs: [
