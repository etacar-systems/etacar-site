  ...
  const cases = [
    {
      ...
      challenge: 'A global e‑commerce company was facing increasing complexity in customer support: more products, more regions, more exceptions. Handling time for complex cases was growing, and senior agents were spending a lot of time on manual investigation and drafting responses.',
      whatWeDid: [
    ...
    },
    {
      ...
      challenge: 'A financial services provider needed to speed up periodic KYC reviews. Manual data collection and drafting risk assessments were consuming a lot of analyst time. At the same time, risk and compliance teams could not accept lower control.',
      whatWeDid: [
    ...
    },
    {
      ...
      challenge: 'A digital services company had thousands of contracts, policies and technical documents spread across different tools and repositories. Teams were spending hours searching, re‑reading and copying fragments into new documents — or they were simply guessing.',
      whatWeDid: [
    ...
    },
    {
      ...
      challenge: 'A technology company needed to deliver new features in a core platform faster, without increasing defect rates or technical debt. Traditional development cycles were too slow, and previous “AI code helper” experiments did not fit their architecture and quality standards.',
      whatWeDid: [
