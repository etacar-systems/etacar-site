  ...
  const principles = [
    {
      ...
      description: 'We see every engagement as a partnership, not a one-off project. We start with your reality — existing systems, constraints, risk and culture.',
      icon: (
    ...
    },
    {
      ...
      description: 'We focus on a small number of high-impact initiatives, not AI "everywhere". This ensures meaningful results and sustainable implementation.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      description: 'We align on KPIs and decision criteria for each initiative before we start building. This ensures measurable success and clear accountability.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      description: 'We design AI systems that are operationally sustainable — with clear ownership, monitoring and governance for long-term success.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <p className={styles.intro}>
            We see every engagement as a partnership, not a one-off project:
          </p>
          ...
          <p className={styles.conclusion}>
            This is how we make sure our work is meaningful for your organization and safe for your business-critical operations.
          </p>
        </div>
      </div>
    </SectionWrapper>
