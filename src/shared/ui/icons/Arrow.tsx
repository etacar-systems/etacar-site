...
const ArrowSvg: React.FC<IconProps> = ({mainColor = '#1F1F1F'}) => (
...
export const ArrowIcon = forwardRef<SVGSVGElement, IconProps>((props, ref) => {
    const {mainColor, ...restProps} = props;

    return <ArrowSvg mainColor={mainColor} {...restProps} ref={ref as any}/>;
});
