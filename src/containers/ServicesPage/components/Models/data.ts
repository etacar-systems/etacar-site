...
export const data = [
  {
    ...
    description:
      'Engage a reliable and involved team with your project. Ourсaim is to develop long-term relationships as the go-to outsourcing partner in Belarus and smaller, fixed price tasks are a good way to start.',
    advantages: [
  ...
  },
  {
    ...
    description:
      'We provide top-notch developers that will help you implement the best practices of product development. Our professionals have a long history working with Agile development methodology on numerous projects, and they will share their real world experience with your dedicated team.',
    advantages: [
