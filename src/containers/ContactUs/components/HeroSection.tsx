      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <p className={styles.subtitle}>
            We're a senior AI engineering team with 20+ years of experience building AI-powered systems
            for business-critical operations. Whether you need strategic guidance, technical implementation,
            or end-to-end delivery — we're here to help.
          </p>
