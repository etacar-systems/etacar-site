...
const MobileSvg: React.FC<IconProps> = ({mainColor = '#1F1F1F'}) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd"
              ...
              fill={mainColor}/>
        <path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 4.5H16.5V6H7.5V4.5ZM16.25 4.75H7.75V5.75H16.25V4.75Z"
              fill={mainColor}/>
    </svg>
);
...
export const MobileIcon = forwardRef<SVGSVGElement, IconProps>((props, ref) => {
    ...
    return <MobileSvg mainColor={mainColor} {...restProps} ref={ref as any}/>;
});
