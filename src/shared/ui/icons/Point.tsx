...
const PointSvg= ({mainColor = 'currentColor'}: IconProps): ReactElement =>  (
...
export const PointIcon = forwardRef<SVGSVGElement, IconProps>((props, ref) => {
  const {mainColor, ...restProps} = props;

  return <PointSvg mainColor={mainColor} {...restProps} ref={ref}/>;
});
