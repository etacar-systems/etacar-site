...
export const fullServices = {
  fullServicesPage: {
    title: 'Services',
    subtitle: 'We design, build and operate AI solutions for business-critical operations — from strategy and architecture to copilots, automation and governance.',
    ...
    sections: [
      ...
      },
      {
        ...
        problem: 'Critical knowledge is often buried in documents, shared drives and legacy systems. People spend hours searching, or simply guess. That doesn’t work when regulators, customers or partners expect clear answers.',
        whatWeDeliver: [
      ...
      },
      {
        ...
        problem: 'As AI projects multiply, it becomes difficult to answer simple questions: How many AI systems do we have? Who owns them? How do we know they are working as intended — and safely?',
        whatWeDeliver: [
