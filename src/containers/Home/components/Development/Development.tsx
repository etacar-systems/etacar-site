      ...
      <div className={styles.container}>
        ...
        <div>
          <div className={styles.description}>
            Eta Car Systems provides professional software development solutions
            for European/US clients. Our experienced engineers ensure
            personalized services, prioritizing your needs. We follow Agile
            processes and offer cost-effective Ruby on Rails,
            JavaScript/TypeScript, UI/UX, and DevOps solutions.
          </div>
